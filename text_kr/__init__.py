...
from text_kr import cleaners
from text_kr.symbols import symbols, en_symbols, PAD, EOS
from text_kr.korean import jamo_to_korean



# Mappings from symbol to numeric ID and vice versa:
_symbol_to_id = {s: i for i, s in enumerate(symbols)}   # 80
