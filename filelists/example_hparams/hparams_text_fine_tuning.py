...
defaults = {
    ...
    'training_files':'filelists/kss/train_0.5_shard.txt', # Filelists for training data. For the specific format of each line, follow the example filelists.
    'validation_files':'filelists/kss/val.txt', # Filelists for validation data.
    ...
    'text_finetune':True, 
    'speech_dewarping':False,
    'naive_speech_autoencoder':False,
    
    'iskorean':True, # This option matters only when text_finetune is True. It denotes whether the fine-tuning text is Korean or not. This repository only supports English and Korean.
    ...
    'segaug':True, # Whether to use the proposed SegAug augmentation during text-fine tuning. In the pre-training scenarios, this option is not used.
    ...
    'use_lr_schedule':True, # If True, a learning rate schedule is used. Refer to line186 in train.py.
